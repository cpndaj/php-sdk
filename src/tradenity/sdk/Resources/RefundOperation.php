...
/**
 * RefundOperation Class Doc Comment
 *
 * @category Class
 * @package  Tradenity\SDK
 * @author   Tradenity team
...
class RefundOperation
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RefundOperation';
     ...
     * @return \\Resources\page[RefundOperation]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllRefundOperations(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllRefundOperations();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllRefundOperations($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllRefundOperations($parameters)[0];
    }
    ...
    */
    ...
    /**
    * Operation listAllRefundOperations
    *
    * List RefundOperations
    *
    ...
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\RefundOperation[page]
    */
    public static function listAllRefundOperations(array $parameters = [])
    {
        list($response) = self::listAllRefundOperationsWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllRefundOperationsWithHttpInfo
     *
     * List RefundOperations
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\RefundOperation[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllRefundOperationsWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\RefundOperation[page]'; 
        $request = self::listAllRefundOperationsRequest($parameters);  
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\RefundOperation[]',
    ...
    /**
     * Operation listAllRefundOperationsAsync
     *
     * List RefundOperations
     *
     ...
     */
    public static function listAllRefundOperationsAsync(array $parameters = [])
    {
        return self::listAllRefundOperationsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllRefundOperationsAsyncWithHttpInfo
     *
     * List RefundOperations
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllRefundOperationsAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\RefundOperation[page]'; 
        $request = self::listAllRefundOperationsRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllRefundOperations'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     */ 
    protected static function listAllRefundOperationsRequest(array $parameters = [])  
    {

        $resourcePath = '/refundOperations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
