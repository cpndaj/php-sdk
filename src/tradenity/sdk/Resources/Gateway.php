 ...
 */
     ...
     * @return \\Resources\page[Gateway]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllGateways(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllGateways();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllGateways($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllGateways($parameters)[0];
    }
    ...
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\Gateway[page]
    */
    public static function listAllGateways(array $parameters = [])
    {
        list($response) = self::listAllGatewaysWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllGatewaysWithHttpInfo
     *
     * List Gateways
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Gateway[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllGatewaysWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\Gateway[page]'; 
        $request = self::listAllGatewaysRequest($parameters);  
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\Gateway[]',
    ...
    /**
     * Operation listAllGatewaysAsync
     *
     * List Gateways
     *
     ...
     */
    public static function listAllGatewaysAsync(array $parameters = [])
    {
        return self::listAllGatewaysAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllGatewaysAsyncWithHttpInfo
     *
     * List Gateways
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllGatewaysAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\Gateway[page]'; 
        $request = self::listAllGatewaysRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllGateways'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     */ 
    protected static function listAllGatewaysRequest(array $parameters = [])  
    {

        $resourcePath = '/gateways';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
