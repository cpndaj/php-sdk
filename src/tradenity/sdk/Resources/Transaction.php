 ...
 */
     ...
     * @return \\Resources\page[Transaction]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllTransactions(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllTransactions();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllTransactions($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllTransactions($parameters)[0];
    }
     ...
     *
     * @param  string $id ID of Transaction to return (required)
     *
     * @throws \\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        return self::getTransactionById($id);
    }
    ...
    */
    ...
    {
        self::deleteTransactionById($this->getId());
    }
    ...
    */
    ...
    /**
     * Operation deleteTransactionById
     *
     * Delete Transaction
     *
     ...
     * @return void
     */
    public static function deleteTransactionById($transaction_id)
    {
        self::deleteTransactionByIdWithHttpInfo($transaction_id);
    }


    /**
     * Operation deleteTransactionByIdWithHttpInfo
     *
     * Delete Transaction
     *
     * @param  string $transaction_id ID of transaction to delete. (required)
     ...
     */  
    protected static function deleteTransactionByIdWithHttpInfo($transaction_id)
    {
        $returnType = '';  
    ...
    /**
    * Operation deleteTransactionByIdAsync
    *
    * Delete Transaction
    *
    * @param  string $transaction_id ID of transaction to delete. (required)
    ...
    */
    public static function deleteTransactionByIdAsync($transaction_id)
    {
        return self::deleteTransactionByIdAsyncWithHttpInfo($transaction_id)
            ->then(
                function ($response) {
                    return $response[0];
            }
    ...
    /**
     * Create request for operation 'deleteTransactionById'
     *
     * @param  string $transaction_id ID of transaction to delete. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */  
    protected static function deleteTransactionByIdRequest($transaction_id) 
    {
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null || (is_array($transaction_id) && count($transaction_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transaction_id when calling deleteTransactionById'
            );
        }
     ...
     * Find Transaction
     *
     * @param  string $transaction_id ID of transaction to return (required)
     *
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = self::getTransactionByIdWithHttpInfo($transaction_id);
        return $response;
    }
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Transaction, HTTP status code, HTTP response headers (array of strings)
     */  
    protected static function getTransactionByIdWithHttpInfo($transaction_id)
    {
        $returnType = '\Tradenity\SDK\Resources\Transaction';  
        $request = self::getTransactionByIdRequest($transaction_id); 
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\Transaction',
    ...
    * @return \GuzzleHttp\Promise\PromiseInterface
    */
    public static function getTransactionByIdAsync($transaction_id)
    {
        return self::getTransactionByIdAsyncWithHttpInfo($transaction_id)
            ->then(
                function ($response) {
                    return $response[0];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */  
    protected static function getTransactionByIdAsyncWithHttpInfo($transaction_id) 
    {
        $returnType = '\Tradenity\SDK\Resources\Transaction';  
        $request = self::getTransactionByIdRequest($transaction_id); 
     ...
     * @return \GuzzleHttp\Psr7\Request
     */  
    protected static function getTransactionByIdRequest($transaction_id) 
    {
        // verify the required parameter 'transaction_id' is set
        if ($transaction_id === null || (is_array($transaction_id) && count($transaction_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    * @throws \Tradenity\SDK\ApiException on non-2xx response
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\Transaction[page]
    */
    public static function listAllTransactions(array $parameters = [])
    {
        list($response) = self::listAllTransactionsWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllTransactionsWithHttpInfo
     *
     * List Transactions
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Transaction[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllTransactionsWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\Transaction[page]'; 
        $request = self::listAllTransactionsRequest($parameters);  
    ...
    /**
     * Operation listAllTransactionsAsync
     *
     * List Transactions
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public static function listAllTransactionsAsync(array $parameters = [])
    {
        return self::listAllTransactionsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllTransactionsAsyncWithHttpInfo
     *
     * List Transactions
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllTransactionsAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\Transaction[page]'; 
        $request = self::listAllTransactionsRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllTransactions'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */ 
    protected static function listAllTransactionsRequest(array $parameters = [])  
    {
