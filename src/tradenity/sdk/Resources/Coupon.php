 ...
 */
     ...
     * @return \\Resources\page[Coupon]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllCoupons(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllCoupons();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllCoupons($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllCoupons($parameters)[0];
    }
    ...
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\Coupon[page]
    */
    public static function listAllCoupons(array $parameters = [])
    {
        list($response) = self::listAllCouponsWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllCouponsWithHttpInfo
     *
     * List Coupons
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Coupon[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllCouponsWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\Coupon[page]'; 
        $request = self::listAllCouponsRequest($parameters);  
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\Coupon[]',
     ...
     */
    public static function listAllCouponsAsync(array $parameters = [])
    {
        return self::listAllCouponsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllCouponsAsyncWithHttpInfo
     *
     * List Coupons
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllCouponsAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\Coupon[page]'; 
        $request = self::listAllCouponsRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllCoupons'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     */ 
    protected static function listAllCouponsRequest(array $parameters = [])  
    {
