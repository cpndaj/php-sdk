 ...
 */
     ...
     * @return \\Resources\page[Promotion]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllPromotions(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllPromotions();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllPromotions($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllPromotions($parameters)[0];
    }
    ...
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\Promotion[page]
    */
    public static function listAllPromotions(array $parameters = [])
    {
        list($response) = self::listAllPromotionsWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllPromotionsWithHttpInfo
     *
     * List Promotions
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Promotion[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllPromotionsWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\Promotion[page]'; 
        $request = self::listAllPromotionsRequest($parameters);  
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\Promotion[]',
    ...
    /**
     * Operation listAllPromotionsAsync
     *
     * List Promotions
     *
     ...
     */
    public static function listAllPromotionsAsync(array $parameters = [])
    {
        return self::listAllPromotionsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllPromotionsAsyncWithHttpInfo
     *
     * List Promotions
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllPromotionsAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\Promotion[page]'; 
        $request = self::listAllPromotionsRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllPromotions'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     */ 
    protected static function listAllPromotionsRequest(array $parameters = [])  
    {
