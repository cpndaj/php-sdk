 ...
 */
     ...
     * @return \\Resources\page[Payment]
     */
    public static function findAll($page_request = null)
    {
        if($page_request != null){
            return self::listAllPayments(['page' => $page_request->getPageNumber(), 'size' => $page_request->getSize() ]);
        }else {
            return self::listAllPayments();
        }
    }

    public static function findAllBy(array $parameters = [])
    {
        return self::listAllPayments($parameters);
    }

    public static function findOneBy(array $parameters = [])
    {
        return self::listAllPayments($parameters)[0];
    }
    ...
    * @throws \InvalidArgumentException
    * @return \Tradenity\SDK\Resources\Payment[page]
    */
    public static function listAllPayments(array $parameters = [])
    {
        list($response) = self::listAllPaymentsWithHttpInfo($parameters);
        return $response;
    }

    /**
     * Operation listAllPaymentsWithHttpInfo
     *
     * List Payments
     *
     * @param  int $page page number (optional)
     ...
     * @throws \Tradenity\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Tradenity\SDK\Resources\Payment[page], HTTP status code, HTTP response headers (array of strings)
     */ 
    protected static function listAllPaymentsWithHttpInfo(array $parameters = []) 
    {
        $returnType = '\Tradenity\SDK\Resources\Payment[page]'; 
        $request = self::listAllPaymentsRequest($parameters);  
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Tradenity\SDK\Resources\Payment[]',
    ...
    /**
     * Operation listAllPaymentsAsync
     *
     * List Payments
     *
     ...
     */
    public static function listAllPaymentsAsync(array $parameters = [])
    {
        return self::listAllPaymentsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAllPaymentsAsyncWithHttpInfo
     *
     * List Payments
     *
     * @param  int $page page number (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */ 
    protected static function listAllPaymentsAsyncWithHttpInfo(array $parameters = [])  
    {
        $returnType = '\Tradenity\SDK\Resources\Payment[page]'; 
        $request = self::listAllPaymentsRequest($parameters);  
    ...
    /**
     * Create request for operation 'listAllPayments'
     *
     * @param  int $page page number (optional)
     * @param  int $size page size (optional)
     * @param  string $sort page order (optional)
     ...
     */ 
    protected static function listAllPaymentsRequest(array $parameters = [])  
    {
